...
import { useDrainageData } from "../components/useData";

import { DrainageData } from "./type";
...
const Dashboard = () => {
  ...
  // Use the DrainageData type for better type safety
  const processLineChartData = (data: DrainageData[]): { name: string; waterLevel: number; waterPressure: number }[] => {
  ...
  // Make sure data is typed correctly
  const lineChartData = processLineChartData(data as unknown as DrainageData[]);
